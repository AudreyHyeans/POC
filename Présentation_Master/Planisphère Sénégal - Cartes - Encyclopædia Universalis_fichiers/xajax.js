...
function Xajax()
{
    ...
    this.call = function(sFunction, aArgs, sRequestType)
    {
            ...
            case xajaxRewritedGet:{
                ...
                if (aArgs) {
                    for (i = 0; i<aArgs.length; i++)
                    {
                        ...
                        if (typeof(value)=="object")
                            value = this.objectToXML(value);
                        uriGet += "/"+encodeURIComponent(param)+"/"+encodeURIComponent(value);
                        i++;
                    }
                }
                uriGet += "/";
        ...
        if (!r) return false;
        r.open(xajaxRequestType!=xajaxDefinedPost?"GET":"POST", uri, true);
        ...
        r.setRequestHeader("X-XHR", "application/xajax");
